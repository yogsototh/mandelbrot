...
And a video made with `avconv` (`ffmpeg`); see the `run` script:

<iframe src="http://player.vimeo.com/video/61190538" width="800" height="500" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
